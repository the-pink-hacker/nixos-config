...

{
    ...
    programs.plasma = {
        ...
        configFile = {
            ...
            "plasma-org.kde.plasma.desktop-appletsrc"."Containments/70/Applets/73/Configuration/General".launchers = builtins.concatStringsSep "," [
                "applications:systemsettings.desktop"
                "preferred://filemanager"
                "applications:org.kde.konsole.desktop"
                "file:///nix/store/50j636yfysg18l83bnxlpk66np5k0fnr-home-manager-path/share/applications/firefox.desktop"
                "applications:steam.desktop"
                "file:///nix/store/jd0yx5m3qw58nmpwm9iadsj1r35wdmmb-user-environment/share/applications/discord.desktop"
                "applications:thunderbird.desktop"
                "applications:org.kde.elisa.desktop"
                "applications:blockbench.desktop"
                "file:///nix/store/7zppq29cks2hmgvcjmxdzvk0qwmjfiia-system-path/share/applications/org.kde.tokodon.desktop"
                "file:///nix/store/75yyl1j49hs4fv8x1ri7xnl3ij7xhfrd-system-path/share/applications/spotify.desktop"
            ];
        };
        shortcuts = {
